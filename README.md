...
Wait for a few seconds for site to load. If the site features are not working, keep refreshing the page and clearing the browser cache and trying again. These issues are from https://render.com/ free plan as they were not there when the site was live on Heroku free plan.
